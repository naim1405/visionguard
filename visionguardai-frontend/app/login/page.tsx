...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 px-4 transition-colors duration-300">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Sign in to your VisionGuard AI account
          </p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-gray-600 dark:text-gray-400">
          Protected by VisionGuard AI Security
        </p>
      </div>
    </div>
  )
